...
during the preflight phase, plots use diverse coverage. Once Colab has run
...
Usage:
    ...
    python scripts/analysis/pick_top_k.py
    # or with custom params:
    python scripts/analysis/pick_top_k.py --k 3 --include-large-llms
...
from scripts.common.experiment_io import log_info, log_section
