...
SRC_REC = EVIDENCE_DIR / "source_records"
...
mut_script_path = REPO_ROOT / "scripts" / "validation" / "run_mutation_tests.py"
...
all_art_files = sorted([f for f in EVIDENCE_DIR.rglob("*") if f.is_file() and not f.name.startswith(".")])
