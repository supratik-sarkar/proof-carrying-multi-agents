#!/usr/bin/env python3
"""AST-based Meta-Validator for Python scripts under artifacts/evidence and scripts/validation."""
...
print("=================================================================")
print("=== AST-BASED META-VALIDATOR FOR ALL VALIDATION PYTHON SCRIPTS ===")
print("=================================================================\n")

py_files = sorted([f for f in (list(EVIDENCE_DIR.rglob("*.py")) + list(SCRIPTS_DIR.rglob("*.py"))) if f.is_file()])
