#!/usr/bin/env python3
"""Finalizes validation artifacts from server run records."""
...
def main():
    parser = argparse.ArgumentParser(description="Finalize validation artifacts.")
    parser.add_argument("--server-output-dir", type=Path, default=Path("results/server_runs"))
    parser.add_argument("--allow-pending", action="store_true")
    args = parser.parse_args()

    print("=== FINALIZING VALIDATION ARTIFACTS ===")
