...
DEFAULT_SOURCE_REC = EVIDENCE_DIR / "source_records" / "per_example_records.jsonl"
FROZEN_MANIFEST_PATH = EVIDENCE_DIR / "config" / "clean_room_expected_outputs.json"
...
def run_clean_room_validation(source_records_path=None, frozen_manifest_path=None, output_path=None):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        for sub in SUBDIRS:
            sub_script = EVIDENCE_DIR / sub / "scripts" / "reproduce_all.py"
        ...
        for rel_p, exp_hash in expected_hashes.items():
            ...
            canonical_file = EVIDENCE_DIR / rel_p
