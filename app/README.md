...
**Anonymous submission for double-blind review.** This Space supports
...
GPT-4, Claude, etc.), paste an API key in the sidebar — keys are
stored only in the browser session and are never logged or persisted.
